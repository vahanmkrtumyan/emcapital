    ...
    <Layout cls="">
      ...
      <section className="up-box grey-bg">
        <div className="container">
          <div className="box">
            <div>
              <img
                src="../../static/img/benifits-1.png"
                alt="Increasing value"
              />
              <h3>{t("professionalism")}</h3>
              <p>{t("arzheqiMetsatsum")}</p>
            </div>
            <div>
      ...
      <section id="offers" className="offer grey-bg">
        <div className="container">
          ...
          <ul className="card-wrap">
            <li className="card">
              <h3>{t("allocation")}</h3>
              <p>{t("allocationText")}</p>
              <img
                src="../../static/img/undraw_folder_39kl.png"
                alt="Finances"
              />
            </li>
            <li className="card">
              <h3>{t("instruments")}</h3>
              <p>{t("instrumentsText")}</p>
      ...
      <section className="investment">
        ...
        <div className="investment-content">
          <p className="text-center">{t("gravchutyunText")}</p>
        </div>
      </section>
      <section id="news" className="subscribe">
        <div className="container">
          <div className="subscribe-content">
            ...
            <p className="text-center">{t("newslatterText")}</p>
